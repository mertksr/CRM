                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <table id="islemler" class="table dt-table-hover" style="width:100%">
                                        ...
                                        <?php
                                        $randevusor = $db->prepare("SELECT * from randevular");
                                        $randevusor->execute();
                                        $say = 0;
                                        while ($randevucek = $randevusor->fetch(PDO::FETCH_ASSOC)) {
                                            $say++;
                                            $modalId = "modal" . $randevucek["rID"];
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body row">
                                                                    ...
                                                                    <div class="row g-1">
                                                                        ...
                                                                        <div class="form-group col-6">
                                                                            <label for="exampleFormControlInput1">Talep Edilen Çalışan </label>
                                                                            <input type="text" readonly class="form-control contact-modal" id="exampleFormControlInput1" value="<?php echo $randevucek['rTalepEdilenCalisan']; ?>">
                                                                        </div>
                                                                        <div class="form-group col-6">
                                                ...
                                                <td style="text-align:center;">
                                                    <a class="btn btn-ozel mr-2" data-bs-toggle="modal" data-bs-target="#<?php echo $modalId; ?>">
                                                        ...
                                                        <div class="modal-body row">
                                                            ...
                                                            <div class="row g-1">
                                                                ...
                                                                <form action="../netting/randevuislem.php" method="POST">
                                                                    ...
                                                                    <input type="hidden" name="randevuid" value="<?= $randevucek['rID']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
