                     ...
                     ?>   
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $say ?></td>
                                                <td><?php echo $mustericek['mAdSoyad']; ?></td>
                                                <td><?php echo $mustericek['mBolge']; ?></td>
                                                <td><?php echo $yeni_tarih; ?></td>
                                                <td>
                                                <div class="text-center">
                                        <button type="button" class="btn btn-primary mr-2" data-bs-toggle="modal" data-bs-target="#<?php echo $modalId; ?>">
                                          İletişim Bilgisi
                                        </button>
                                    </div>
<!-- Modal -->
...
<?php }   ?>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="musteridetay.php"  class="btn btn-dark btn-sm">Detay</a>
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                                            <a class="dropdown-item" href="#">İşlem ekle</a>
