        ...
        <div class="container" style="margin: 0 auto;">
          <div class="row layout-top-spacing" id="cancel-row">
            <div id="flLoginForm" class="col-lg-12  layout-spacing">
              <a href="musteriler.php" class="btn btn-warning mb-1">Geri Dön</a>
                  ...
                  <form class="row g-2" method="POST" id="musteriduzenleform" action="../netting/musteriduzenlesyf.php">
                    ...
                    <div class=" col-3">
                      ...
                      <select  id="defaultInputState" name="periyot" class="form-select select">
                        <option value="6" <?php if($mustericek['mPeriyot']=="6"){echo 'selected';} ?>>6</option>
                        <option value="12"<?php if($mustericek['mPeriyot']=="12"){echo 'selected';} ?>>12</option>
                        <option value="3"<?php if($mustericek['mPeriyot']=="3"){echo 'selected';} ?>>3</option>
                        <option value="1"<?php if($mustericek['mPeriyot']=="1"){echo 'selected';} ?>>1</option>
                        <option value="2"<?php if($mustericek['mPeriyot']=="2"){echo 'selected';} ?>>2</option>
                        <option value="4"<?php if($mustericek['mPeriyot']=="4"){echo 'selected';} ?>>4</option>
                        <option value="5"<?php if($mustericek['mPeriyot']=="5"){echo 'selected';} ?>>5</option>
                        <option value="7"<?php if($mustericek['mPeriyot']=="7"){echo 'selected';} ?>>7</option>
                        <option value="8"<?php if($mustericek['mPeriyot']=="8"){echo 'selected';} ?>>8</option>
                        <option value="9"<?php if($mustericek['mPeriyot']=="9"){echo 'selected';} ?>>9</option>
                        <option value="10"<?php if($mustericek['mPeriyot']=="10"){echo 'selected';} ?>>10</option>
                        <option value="11"<?php if($mustericek['mPeriyot']=="11"){echo 'selected';} ?>>11</option>
                      </select>
                    </div>
