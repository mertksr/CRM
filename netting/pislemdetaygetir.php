...
<div class="col-6">
    <label for="inputAddress2" class="form-label">İşlem Tarihi</label>
    <input type="text" readonly class="form-control info-input" value="' . date("d.m.Y", strtotime($islemcek['islemTarihi'])) . '" name="islemnotlari" id="inputAddress2">
</div>
